...
import { X, Sparkles, Plus, Check, ChevronLeft } from 'lucide-react';
...
const CompanyCreatePhase = () => {
    const navigate = useNavigate();
    const { companyProjects, fetchCompanyProjects, createPhase } = useCompany();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (success) {
                ...
                // Could also navigate to the specific project details page if we had that route set up for companies
            }
        } catch (error) {
        ...
        <CompanyLayout>
            <div className="max-w-5xl mx-auto space-y-6 pb-10">
                <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Create Phase</h1>
                        <p className="text-muted-foreground mt-1">Add a new phase to one of your projects</p>
                    </div>
                </div>
                    ...
                    <CardContent className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input name="name" value={formData.name} onChange={handleInputChange} required placeholder="e.g. Phase 1 - Tower A" />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea name="description" value={formData.description} onChange={handleInputChange} placeholder="Detailed description of this phase" rows={4} />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input name="constructionStatus" value={formData.constructionStatus} onChange={handleInputChange} placeholder="e.g. Planning Phase, Foundation Work" />
                        </div>

                        <div className="space-y-2">
                            <Label>Completion Percentage (%)</Label>
                            <Input name="completionPercentage" type="number" min="0" max="100" value={formData.completionPercentage} onChange={handleInputChange} />
                        </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input type="file" onChange={(e) => handleFileChange(e, 'logoFile')} accept="image/*,.pdf" />
                        </div>
                        <div className="space-y-2">
                            <Label>Brochure File</Label>
                            <Input type="file" onChange={(e) => handleFileChange(e, 'brochureFile')} accept=".pdf,.doc,.docx" />
                        </div>
                        <div className="space-y-2">
                            <Label>Master Plan File</Label>
                            <Input type="file" onChange={(e) => handleFileChange(e, 'masterPlanFile')} accept="image/*,.pdf" />
                        </div>
                        <div className="space-y-2">
                            <Label>Floor Plan Files (Multiple)</Label>
                            <Input type="file" multiple onChange={(e) => handleFileChange(e, 'floorPlanFiles')} accept="image/*,.pdf" />
                        </div>
                    </CardContent>
                </Card>
...
export default CompanyCreatePhase;
