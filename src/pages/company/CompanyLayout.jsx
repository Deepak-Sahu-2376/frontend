            ...
            <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
                ...
                <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 md:px-8 sticky top-0 z-10">
                    <div className="flex items-center md:hidden">
                        ...
                        <span className="text-xl font-bold text-gray-900 ml-2">Company</span>
                    </div>

                    <div className="flex items-center space-x-4 ml-auto">
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="flex items-center space-x-3 pl-4 md:border-l border-gray-200 outline-none">
