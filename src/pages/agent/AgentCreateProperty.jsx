...
const AgentCreateProperty = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const propertyData = {
                ...formData,
                // Include companyId and companyName only if they exist in the user object (i.e., for Company Agents)
            ...
            if (response.ok) {
                ...
                // Wait for the toast roughly before navigating?
                // Ideally, navigation happens immediately, toast persists.
